...
| `elkvariants` | 3.7.2 | ElkVariants | universal |
...
| `gourmand` | 1.8.12 | Gourmand | universal |
| `hydrateordiedrate` | 2.5.4 | Hydrate Or Diedrate | universal |
| `immersivelanterns` | 0.4.1 | Immersive Lanterns | universal |
| `interestingoregen` | 2.3.8 | Interesting Ore Gen | universal |
| `materialneeds` | 2.0.0 | Material Needs | universal |
...
| `sapglasscraft` | 1.0.1 | Andrea's Craftable Glass Variants | universal |
...
| `tailorsdelight` | 2.2.2 | Tailor's Delight | universal |
...
| `vsquest` | 3.1.0 | VS Quest | universal |
